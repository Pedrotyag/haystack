...
RSpec.describe Haystack::Cron::MonitorConfig do
  ...
  describe '.from_crontab' do
    it 'has correct attributes' do
      ...
      expect(subject.schedule).to be_a(Haystack::Cron::MonitorSchedule::Crontab)
  ...
  describe '.from_interval' do
    ...
    it 'has correct attributes' do
      ...
      expect(subject.schedule).to be_a(Haystack::Cron::MonitorSchedule::Interval)
      expect(subject.schedule.value).to eq(5)
