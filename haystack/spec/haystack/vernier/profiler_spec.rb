...
RSpec.describe Haystack::Vernier::Profiler, when: { ruby_version?: [:>=, "3.2.1"] } do
  subject(:profiler) { described_class.new(Haystack.configuration) }
    ...
    describe '#to_hash' do
      ...
      context 'with single-thread profiled code' do
        ...
        it 'has correct frames' do
          ...
          expect(foo_frame[:abs_path]).to include('haystack/haystack/spec/support/profiler.rb')
        end
