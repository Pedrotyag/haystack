...
RSpec.describe Haystack::PropagationContext do
  before do
    perform_basic_setup
  end

  let(:scope) { Haystack.get_current_scope }
  ...
  describe "#initialize" do
    ...
    it "generates correct attributes when incoming haystack-trace and baggage" do
      env = {
        "haystack-trace" => "771a43a4192642f0b136d5159a501700-7c51afd529da4a2a",
      ...
      expect(subject.baggage).to be_a(Haystack::Baggage)
    ...
    it "generates correct attributes when incoming HTTP_HAYSTACK_TRACE and HTTP_BAGGAGE" do
      env = {
        "HTTP_HAYSTACK_TRACE" => "771a43a4192642f0b136d5159a501700-7c51afd529da4a2a",
    ...
    it "generates correct attributes when incoming haystack-trace only (from older SDKs)" do
      env = {
        "haystack-trace" => "771a43a4192642f0b136d5159a501700-7c51afd529da4a2a"
      }
  ...
  describe "#get_baggage" do
    ...
    it "populates head baggage" do
      ...
      expect(baggage.items).to eq({
        ...
        "environment" => "test",
        "release" => "foobar",
        "public_key" => Haystack.configuration.dsn.public_key
      })
    end
  end
